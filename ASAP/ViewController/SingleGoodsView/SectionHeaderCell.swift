...
//  ASAP
//
//  Created by HsuTony on 2015/9/23.
...
class SectionHeaderCell: UITableViewCell , UIScrollViewDelegate {
    ...
    override func drawRect(rect: CGRect) {
        ...
        self.setButtonsTextColor(UIColor.brownColor())
...
//            blurView.setTranslatesAutoresizingMaskIntoConstraints(false)
    ...
    internal func scrollViewDidScroll(scrollView: UIScrollView)
    {
        ...
        animatedBar.frame =
            CGRectMake((offsetAddition + (contentView.frame.size.width * (CGFloat)(scaleY))),
                        animatedBar.frame.origin.y,
                        animatedBar.frame.size.width,
                        animatedBar.frame.size.height);
        
//        println("y : \(animatedBar.frame.origin.y)")
//        println("width : \(animatedBar.frame.size.width)")
//        println("height : \(animatedBar.frame.size.height)")
...
//        var scaleY = (CGFloat)(scrollView.contentOffset.y / (contentView.frame.size.height * (CGFloat)(buttonTitles.count)))
